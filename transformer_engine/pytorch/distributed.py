...
def _get_active_autocast_contexts():
    ...
    gpu_autocast_ctx = torch.amp.autocast(device_type="cuda",
        enabled=gpu_autocast_enabled, dtype=gpu_autocast_dtype, 
    ...
    cpu_autocast_ctx = torch.amp.autocast(device_type="cpu",
        enabled=cpu_autocast_enabled, dtype=cpu_autocast_dtype, 
        cache_enabled=autocast_cached
    )
